  ...
  return (
    ...
    >
      <Link
        ...
        className={clsx(
          'relative flex h-full items-center justify-center border-l border-white/25 px-7 text-center font-nunito text-lg font-bold transition duration-100 ease-in-out',
          {
