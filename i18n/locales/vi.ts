const translations = {
  ...
  chapter_one: {
    ...
    intro_one: {
      ...
      paragraph_two: `—Deborah Chunk: “Thomas Vanderpoole. Là Giám đốc điều hành của BitRey, ăn mặc lịch lãm, cho đến nay, ông đã và đang điều hành mỏ khai thác (đào) khối bitcoin lớn nhất thế giới. Ông cũng sản xuất máy khai thác (đào) khối bitcoin. Điều gì đang xảy ra? Bitcoin đang chết?”`,       // —Deborah Chunk: “Thomas Vanderpoole. As the well-dressed CEO of BitRey, you run, by far, the largest bitcoin mining pool in the world. You also manufacture bitcoin mining machines. What is happening? Is bitcoin dying?”
  ...
  chapter_two: {
    ...
    mining_one: {
      ...
      paragraph_nine:
          'Có thể mất thêm chút thời gian. Nhưng việc này cho bạn thấy việc khai thác (đào) khối khối dữ liệu và xác nhận giao dịch khó như thế nào.', // This might take some time. But this shows you how hard it is to mine blocks and confirm transactions.
      paragraph_ten:
  ...
  chapter_three: {
    ...
    intro_one: {
      ...
      paragraph_one:
          '—SATOSHI NAKAMOTO: “Này, bạn! Đúng vậy, bạn! Nhớ tôi chứ? Bitcoin hiện đang bị tấn công 51%! Sau khi bạn đưa các thiết bị khai thác (đào) khối trực tuyến, Vanderpoole đã bật lại các ASIC của BitRey và đang khai thác (đào) khối các khối trống. Vấn đề là không chỉ có máy móc của anh ta. Anh ta đã sử dụng một cửa hậu trên firmware ASIC tiêu chuẩn để lây nhiễm virus cho các máy đào hiện có, ngăn chặn chúng khai thác (đào) khối bất cứ ký tự gì ngoài các khối trống. Anh ta đang cố gắng bắt cóc hệ sinh thái bitcoin và buộc mọi người ủng hộ ý tưởng tăng nguồn cung bitcoin. Hãy làm gì đó, đồ ngốc!”',       // —SATOSHI NAKAMOTO: “Hey, you! Yeah, you! Remember me? Bitcoin is being hit with a 51% attack right now! After you brought those mining devices online, Vanderpoole turned BitRey’s ASICs back on and is mining empty blocks. The problem is it’s not just his machines. He used a backdoor on the standard ASIC firmware to infect existing miners with a virus that prevents them from mining anything but empty blocks. He’s trying to hold the bitcoin ecosystem hostage and force people to support the idea of increasing bitcoin’s supply. Do something, dingdong!”
      paragraph_two:
          'Máy tính cũ khạc ra một đám bụi, sau đó tạo ra một tập dữ liệu được gọi là "bảng tính" chứa thông tin liên hệ của một số Máy (thợ) đào bitcoin lớn nhất, cũng như bản vá cho virus. Bạn càng sớm có thể gửi bản vá cho các Máy (thợ) đào khác, họ càng sớm có thể giành lại quyền kiểm soát máy móc của mình và tham gia cuộc chiến chống lại BitRey.',       // The old computer coughs up a cloud of dust, then produces a wad of data called a “spreadsheet” that contains contact info for some of the largest bitcoin miners, as well as a patch for the virus. The sooner you can get the patch to other miners, the sooner they can regain control of their machines and join your fight against BitRey.
      paragraph_three:
    ...
    pool_one: {
      ...
      waiting_screen_paragraph_one: `Các máy đào của bạn trong nhà kho không có cơ hội. Nếu bạn kết hợp sức mạnh mã hóa của mình với các Máy (thợ) đào khác, bạn có thể giữ vững lập trường chống lại cuộc tấn công của BitRey.`,       // Your miners in the warehouse don’t stand a chance. If you combine your hash power with other miners, you might be able to hold the line against BitRey's assault.
    ...
    pool_two: {
      ...
      step_zero_paragraph_one:
          'Bằng cách kết hợp sức mạnh mã hóa của bạn với các Máy (thợ) đào khác, bạn có thể chống lại BitRey không?',       // By pooling your hashrate with other miners, can you stand up to BitRey?
    ...
    coop_one: {
      ...
      paragraph_two:
          'Vấn đề là tất cả mọi người đang kiểm tra cùng một nonce khi họ đang khai thác (đào) khối. Làm thế nào để bạn có thể phối hợp tốt hơn?',            // The problem is that everyone is checking the same nonces while they’re mining. How can you better coordinate?
      paragraph_three:
    ...
    coop_two: {
      ...
      list_two:
          'Nó cho phép pool gửi cùng một danh sách giao dịch cho tất cả các Máy (thợ) đào đang cùng khai thác (đào) khối. Điều đó có nghĩa là Máy (thợ) đào chỉ cần cập nhật “extranonce2” và không thay đổi các giao dịch được bao gồm trong khối.',       // It allows the pool to send the same transaction list to all miners that are pooling together. That means miners simply have to update “extranonce2” and not change transactions included in the block.
      list_three:
          '“extranonce1” cho phép các pool xác định và xác định đóng góp cổ phần vì mỗi Máy (thợ) đào đều có “extranonce1” riêng của mình.',       // The “extranonce1” allows pools to identify and determine share contribution because each miner gets their own “extranonce1”.
      paragraph_three:
          'Các Máy (thợ) đào đóng góp vào một pool cập nhật “extranonce2” và lặp qua nonce trong tiêu đề khối. Nếu họ không tìm thấy giải pháp, họ sẽ lặp lại quy trình với “extranonce2” khác cho đến khi họ tìm thấy.', // Miners who contribute to a pool update the “extranonce2” and cycle through the nonce in the block header. If they don’t find a solution, they repeat the process with a different “extranonce2” until they do.
    ...
    resources: {
      solo: {
        hashrate_heading: 'Tốc độ mã hóa khai thác (đào) khối', // Mining Hashrate
        hashrate_paragraph:
      ...
      coop: {
        ...
        distribution_paragraph:
            "Các pool khai thác (đào) khối thực hiện các biện pháp phòng ngừa để đảm bảo rằng những người tham gia của họ không khai thác (đào) khối cùng một nonce cho cùng một khối. Điều này rất quan trọng bởi vì, trong quá trình khai thác (đào) khối bitcoin, các Máy (thợ) đào cạnh tranh để tìm một nonce hợp lệ trong mỗi khối giao dịch. Nếu hai Máy (thợ) đào trong cùng một pool làm việc trên cùng một nonce đồng thời, điều đó sẽ không hiệu quả và chỉ một người sẽ nhận được phần thưởng khối. Để ngăn chặn điều này, các pool khai thác (đào) khối sử dụng một quy trình gọi là 'giao việc' hoặc 'phân phối công việc' để phân bổ công việc hiệu quả. Các pool khai thác (đào) khối phân phối công việc cho từng Máy (thợ) đào hoặc người tham gia. Khi cần khai thác (đào) khối một khối mới, máy chủ của pool (hoặc nhà điều hành pool) tạo ra một 'công việc' duy nhất cho các Máy (thợ) đào. Công việc này bao gồm tất cả thông tin cần thiết để khai thác (đào) khối khối, chẳng hạn như danh sách giao dịch chưa xác nhận hiện tại, tiêu đề của khối trước đó và độ khó mục tiêu.",                 // Mining pools take precautions to ensure that their participants do not mine the same nonce for the same block. This is important because, in the bitcoin mining process, miners compete to find a unique, valid 'nonce' in each block of transactions. If two miners in the same pool were to work on the same nonce simultaneously, it would be inefficient, and only one would receive the block reward. To prevent this, mining pools use a process called 'work assignment' or 'job distribution' to allocate work efficiently. Mining pools distribute work to individual miners or participants. When a new block needs to be mined, the pool's server (or pool operator) creates a unique 'job' for the miners. This job includes all the information needed to mine the block, such as the current list of unconfirmed transactions, the previous block's header, and the target difficulty.
        shares_heading: 'Gửi cổ phần', // Submitting Shares
        shares_paragraph:
            "Các Máy (thợ) đào làm việc trên các công việc được giao này và liên tục cố gắng tìm ra nonce chính xác. Khi một Máy (thợ) đào tin rằng họ có một giải pháp, họ gửi cái gọi là 'cổ phần' cho máy chủ pool. Cổ phần này chứng minh rằng Máy (thợ) đào đang tích cực làm việc để giải quyết vấn đề. Cổ phần dễ tìm thấy hơn nhiều so với giải pháp thực tế, nhưng chúng đóng vai trò là bằng chứng về nỗ lực của Máy (thợ) đào.",         // Miners work on these assigned jobs and continuously attempt to find the correct nonce. When a miner believes they have a solution, they submit what's called a 'share' to the pool server. This share demonstrates that the miner is actively working on solving the problem. Shares are much easier to find than the actual solution, but they serve as proof of the miner's efforts.
      },
      split: {
        title: 'Phương thức thanh toán', // Payout Schemes
        nav_title: 'Chia sẻ công bằng', // Splitting the fair share
        payout_subheading:
            'Một pool khai thác (đào) khối có thể chọn phân phối phần thưởng khối theo một số cách khác nhau, khác nhau ở một số cách tinh tế nhưng quan trọng:', // A mining pool can choose to distrubute the block rewards in several ways the differ in some subtle but key ways:
        pps_heading: 'Trả tiền cho mỗi cổ phần (PPS)', // Pay-Per-Share (PPS)
        pps_paragraph:
            "Trong PPS, Máy (thợ) đào nhận được khoản thanh toán cố định cho mỗi cổ phần hợp lệ mà họ gửi, bất kể pool có khai thác (đào) khối thành công một khối hay không. Hệ thống này cung cấp cho Máy (thợ) đào thu nhập ổn định và dự đoán được, làm cho nó trở thành lựa chọn ưa thích cho những người đánh giá cao tính nhất quán trong thu nhập của họ. PPS giảm thiểu sự biến động trong phần thưởng, vì Máy (thợ) đào được đền bù cho công việc của họ trên cơ sở mỗi cổ phần, cung cấp một nguồn thu nhập đáng tin cậy trong thế giới khai thác (đào) khối tiền mã hóa biến động. Tuy nhiên, PPS có thể khấu trừ một khoản phí từ thu nhập của Máy (thợ) đào nếu pool không khai thác (đào) khối thành công một khối. Khoản phí này nhằm trang trải chi phí hoạt động và giảm thiểu rủi ro cho nhà điều hành pool trong trường hợp không khối nào được khai thác (đào) khối trong một khoảng thời gian nhất định. Trong PPS truyền thống, Máy (thợ) đào nhận được khoản thanh toán giảm khi pool gặp khó khăn.",                 // In PPS, miners receive a fixed payout for each valid share they submit, regardless of whether the pool successfully mines a block or not. This system provides miners with a steady and predictable income, making it a preferred choice for those who value consistency in their earnings. PPS minimizes the variance in rewards, as miners are compensated for their work on a per-share basis, offering a reliable source of income in the world of volatile cryptocurrency mining. However, PPS may deduct a fee from the miner's earnings if the pool doesn't successfully mine a block. This fee is meant to cover operational costs and mitigate the risk for the pool operator in case no blocks are mined within a certain timeframe. In traditional PPS, miners receive a reduced payout when the pool faces difficulties.
        pplns_heading: 'Trả tiền cho N cổ phần cuối cùng (PPLNS)', // Pay-Per-Last-N-Shares (PPLNS)
        pplns_paragraph:
            "PPLNS tính đến đóng góp của Máy (thợ) đào trong một cửa sổ cụ thể của N cổ phần cuối cùng. Máy (thợ) đào được trả tiền dựa trên số lượng và độ khó của các cổ phần mà họ đã gửi trong cửa sổ đó. PPLNS khuyến khích Máy (thợ) đào hoạt động tích cực trong pool, vì nó khen thưởng cho sự tham gia nhất quán và giúp giảm thiểu rủi ro của các chiến lược nhảy pool. Máy (thợ) đào nhận được khoản thanh toán khi pool khai thác (đào) khối thành công một khối và phần thưởng được phân phối tỷ lệ thuận với những đóng góp gần đây của họ, cung cấp một cách tiếp cận công bằng và hiệu quả dựa trên hiệu suất để kiếm tiền trong hệ sinh thái khai thác (đào) khối.",                 // PPLNS takes into account a miner's contribution over a specific window of the last N shares. Miners are paid based on the number and difficulty of shares they've submitted within that window. PPLNS encourages miners to stay active in the pool, as it rewards consistent participation and helps to reduce the risk of pool-hopping strategies. Miners receive payouts when the pool successfully mines a block, and the rewards are distributed proportionally to their recent contributions, providing a fair and performance-driven approach to earning in the mining ecosystem.
        pps_plus_heading: 'Trả tiền cho mỗi cổ phần + (PPS+)', // Pay Per Share + (PPS+)
        pps_plus_paragraph:
            "PPS+ cung cấp cho Máy (thợ) đào khoản thanh toán cố định cho mỗi cổ phần mà họ đóng góp cho nỗ lực khai thác (đào) khối của pool. Tuy nhiên, PPS+ thường bao gồm tiền thưởng hoặc phí bảo hiểm bổ sung như một khuyến khích cho các Máy (thợ) đào đóng góp cho sự ổn định và độ tin cậy của pool. Tiền thưởng này được thiết kế để khuyến khích Máy (thợ) đào hoạt động tích cực trong pool và thúc đẩy sự tham gia lâu dài. PPS+ cung cấp cho Máy (thợ) đào thu nhập ổn định và dự đoán được, trong khi tiền thưởng bổ sung làm cho nó trở thành một lựa chọn hấp dẫn cho những người tìm kiếm cả độ tin cậy và phần thưởng bổ sung trong thế giới khai thác (đào) khối tiền mã hóa.",                 // PPS+ offers miners a fixed payment for each share they contribute to the pool's mining efforts. However, PPS+ typically includes an additional bonus or premium as an incentive to miners who contribute to the pool's stability and reliability. This bonus is designed to encourage miners to stay active in the pool and foster long-term participation. PPS+ provides miners with a consistent and predictable income, while the added bonus makes it an attractive option for those seeking both reliability and extra rewards in the world of cryptocurrency mining.
        fpps_heading: 'Trả tiền đầy đủ cho mỗi cổ phần (FPPS)', // Full Pay Per Share (FPPS)
        fpps_paragraph:
            "Trong Full PPS, Máy (thợ) đào nhận được khoản thanh toán cố định cho mỗi cổ phần mà họ gửi cho pool, bất kể pool có khai thác (đào) khối thành công một khối hay không. Phương pháp này cung cấp cho Máy (thợ) đào thu nhập ổn định và dự đoán được, làm cho nó trở thành một lựa chọn hấp dẫn cho những người đánh giá cao độ tin cậy trong thu nhập của họ. Không giống như PPS truyền thống, Full PPS đảm bảo rằng Máy (thợ) đào nhận được khoản thanh toán đầy đủ cho công việc đóng góp của họ, mà không có bất kỳ khoản khấu trừ nào, ngay cả khi pool gặp khó khăn. Đây là một phương pháp ổn định và đơn giản phù hợp với các Máy (thợ) đào tìm kiếm thu nhập ổn định trong thế giới khai thác (đào) khối tiền mã hóa.",         // In Full PPS, miners receive a fixed payout for every share they submit to the pool, irrespective of whether the pool successfully mines a block or not. This approach provides miners with a steady and predictable income, making it an attractive choice for those who value reliability in their earnings. Unlike traditional PPS, Full PPS ensures that miners receive their full payout for their contributed work, without any potential deductions, even if the pool faces occasional difficulties. It's a stable and straightforward method that appeals to miners seeking consistent income in the world of cryptocurrency mining.
      },
    },
  },
  ...
  chapter_four: {
    ...
    intro_one: {
      ...
      paragraph_one:
          '—HOLOCAT: “Một trong hai chúng ta nên ngủ. Bạn cần bắt đầu liên lạc với phần còn lại của các Máy (thợ) đào. Họ sẽ muốn biết nhiều hơn cả thế giới.”',             // —HOLOCAT: “One of us better sleep. You need to start contacting the rest of the miners. They’ll want to know even more than the world will.”
      paragraph_two:
          'Khi bạn ngồi xuống Bàn làm việc Hover ButtLift, bạn tái hiện lại những sự kiện trong ngày. Vanderpoole. BitRey. Sự tiết lộ rằng các Máy (thợ) đào không bao giờ đồng ý ngừng hoạt động để phản đối. Tất cả có thể đều đúng không? Tất cả những điều này có phải đều được dàn dựng không? Và bạn còn phải chăm sóc con mèo này trong bao lâu nữa? (Ở khoảng cách xa, một tiếng mèo kêu.)',             // As you settle at your ButtLift Hover Desk, you replay the day’s events. Vanderpoole. BitRey. The revelation that miners never agreed to shut down in protest. Could it all be true? Was this all staged? And how much longer are you supposed to look after this cat? (In the distance, something meows.)
      paragraph_three:
    ...
    public_key_one: {
      ...
      paragraph_one:
          'Theo pool khai thác (đào) khối, có vẻ như bạn có 1.61 bitcoin để yêu cầu từ tất cả công việc bạn đã làm trước đó.',             // According to the mining pool, it looks like you have 1.61 bitcoin to claim from all the work you did earlier. 
    ...
    put_it_together_three: {
      normal: {
        ...
        paragraph_four:
          'Lưu ý rằng không có giá trị "đếm" nào cho các witness. Đó là bởi vì số lượng ngăn xếp witness phải luôn bằng chính xác với số lượng đầu vào.', // Notice that there is no "count" value for witnesses. That is because the number of witness stacks must always be exactly equal to the number of inputs.
        paragraph_five:
          'Nhưng đợi đã! Chúng tôi cần bao gồm một "phí". Chúng tôi sẽ cắt giảm một phần nhỏ trong số tiền thừa của chúng tôi từ 61.000.000 xuống còn 60.999.000 satoshi để khuyến khích các nhóm khai thác (đào) khối mỏ đưa giao dịch của chúng tôi vào một khối.', // But wait! We need to include a "fee". We'll shave off a tiny piece of our change output from 61,000,000 to 60,999,000 satoshis to incentivize the mining pools to include our transaction in a block.
        paragraph_six:
