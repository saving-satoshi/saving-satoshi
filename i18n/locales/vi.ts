const translations = {
  ...
  chapter_three: {
    ...
    pool_two: {
      ...
      step_zero_paragraph_one:
          'Bằng việc kết hợp sức mạnh mã hóa của bạn với các máy(thợ) đào khác, bạn nghĩ có thể chống lại BitRey không?', // By pooling your hashrate with other miners, can you stand up to BitRey?
    ...
    coop_two: {
      ...
      list_one: 'Nó chặn những người tham gia pool thực hiện cùng một công việc.', // It prevents pool participants from doing the same work.
      list_two:
      ...
      list_three:
          '“extranonce1” cho phép các pool xác minh và quyết định góp cổ phần vì mỗi máy(thợ) đào đều có “extranonce1” riêng của mình.', // The “extranonce1” allows pools to identify and determine share contribution because each miner gets their own “extranonce1”.
      paragraph_three:
          'Các máy(thợ) đào đóng góp vào một pool cập nhật “extranonce2” và lặp qua nonce trong tiêu đề khối. Nếu họ không tìm thấy giải pháp, họ sẽ lặp lại quy trình với “extranonce2” khác cho đến khi tìm thấy.', // Miners who contribute to a pool update the “extranonce2” and cycle through the nonce in the block header. If they don’t find a solution, they repeat the process with a different “extranonce2” until they do.
...
//Stack Hint: To spend before the secret is revealed, Vanderpoole uses his signature. After the secret is revealed, you use your signature, a hash of the secret, and provide a 0 because the script has moved past the unrevealed verification.
  ...
  chapter_ten: {
    ...
    making_a_payment_one: {
      ...
      list_three_sub_two:
          'Laszlo nhận được tất cả tiền nếu ông ta lấy được khóa riêng tư <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base">REVOCATION_YOU_1</span> từ bạn', //  'Laszlo gets all the money if he gets the private key <span className="rounded-sm px-1.5 py-1 h-[28px] font-mono bg-[#0000004D] m-0.5 text-base">REVOCATION_YOU_1</span> from you'
      list_four:
