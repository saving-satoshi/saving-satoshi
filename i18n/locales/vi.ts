const translations = {
  ...
  chapter_three: {
    ...
    split_two: {
      ...
      step_six_paragraph:
          'Bây giờ chúng ta có thể lấy phần thưởng 7,41 bitcoin và chia theo tỷ lệ (phần trăm) giải pháp mã hóa của mỗi mỏ(pool). Xin chúc mừng!',// Now we can take the rewards of 7.41 bitcoin and split them up according to the percentage of partial solutions of each pool. Congratulations!
    },
    ...
    outro_one: {
      ...
      paragraph_one:
          'Tuyệt vời! Bạn và các máy(thợ) đào khác đã có thể đẩy lùi cuộc tấn công 51% của Vanderpoole bằng cách hợp lực các tài nguyên của mình. Các khối trống đã không còn được gửi nữa và có vẻ như ông ta đã từ bỏ âm mưu.', // Great work! You and the other miners were able to fend off Vanderpoole’s 51% attack by pooling your resources. Empty blocks are no longer being submitted and it looks like he’s given up.
      paragraph_two:
  ...
  chapter_four: {
    ...
    public_key_one: {
      ...
      paragraph_one:
          'Theo mỏ khai thác(pool), có vẻ như bạn có 1.61 bitcoin để yêu cầu từ tất cả công việc bạn đã làm trước đó.',             // According to the mining pool, it looks like you have 1.61 bitcoin to claim from all the work you did earlier. 
