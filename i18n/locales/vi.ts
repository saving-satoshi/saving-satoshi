const translations = {
  ...
  chapter_eight: {
    ...
    building_blocks_six: {
      ...
      paragraph_four:
        'Ở độ cao khối 209.999, trợ cấp là 50 BTC. Trong khối tiếp theo ngay lập tức ở độ cao 210.000, trợ cấp là 25 BTC, v.v. Sau 32 lần "giảm một nửa", trợ cấp sẽ chỉ còn một satoshi duy nhất. Việc giảm một nửa cuối cùng sẽ giảm trợ cấp xuống còn không.', // At block height 209,999 the subsidy was 50 BTC. In the very next block at height 210,000 the subsidy was 25 BTC, and so on. After 63 "halvings" the subsidy will be one single satoshi. The last halving will drop the subsidy to zero.
