const translations = {
  ...
  chapter_nine: {
    ...
    intro_one: {
      ...
      nav_title: 'Threats',
      paragraph_one:
        'Everyone is celebrating; everyone is smiling. But there is one man on set who isn’t happy whatsoever: a tall, well-dressed, gray-haired man who you recognize immediately. The crowd parts, and you see him face to face for the first time: Vanderpoole!',
      paragraph_two:
        'His fists are clenched. You have ruined his business and exposed his family’s long con. The first thing out of his mouth is a threat to sue you every day for the rest of your life.',
    },
    intro_two: {
      title: 'Intro',
      nav_title: 'Coming to terms',
      paragraph_one:
        'As Vanderpoole is ranting, a producer walks in and tells you that viewers from around the world want to support your cause by donating bitcoin and calzones to you, for some reason! Deborah asks you to provide their viewership with a wallet address.',
      paragraph_two:
        'This makes Vanderpoole even more furious. He demands that you split the incoming donations with him, or he’ll drown you in even more lawsuits.',
      paragraph_three:
        'This makes no sense. These donations are coming from people that want to thank you for exposing Vanderpoole’s efforts to change bitcoin. It dawns on you that this is more about him losing. For a moment you even start to feel bad for him. He’s backed himself into a corner with no way out.',
      paragraph_four:
        'As if she was reading your mind, Deborah Chunk steps in. She asks if there is a charity Vanderpoole would like to see a portion of the donations go to. To your surprise, he enthusiastically names the Lil Bits Foundation, a non-profit dedicated to helping children.',
      paragraph_five:
        'Vanderpoole’s complexion calms from beet purple to radish red. You start creating a bitcoin script contract between you and Vanderpoole—he is be responsible for getting the funds to the Lil Bits Foundation. This script contract is what you will use to derive the donation address. It will treat Vanderpoole as an untrustable counterparty and ensure you both can spend from it how and when you agree.',
    },
    opcodes_one: {
      title: 'OpCodes',
