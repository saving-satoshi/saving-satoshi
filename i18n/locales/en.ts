...
const translations = {
  ...
  about: {
    ...
    project: {
      ...
      paragraph_two:
        'This free and open source software (FOSS) project will be in continuous development. Our goal will be to take an iterative approach to incorporate feedback as we release new chapters. There are currently 10 chapters mapped out, however more may be added as the project continues to grow.',
    },
