const translations = {
  ...
  chapter_eight: {
    ...
    building_blocks_six: {
      ...
      paragraph_four: `At block height 209,999 the subsidy was 50 BTC. In the very next block, at height 210,000, the subsidy was reduced to 25 BTC, and it continues to halve every 210,000 blocks. After 32 halvings, the subsidy reaches one single satoshi. The 33rd halving reduces the subsidy to zero, meaning no new bitcoin are created after that.`,
