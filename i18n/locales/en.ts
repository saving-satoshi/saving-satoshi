...
Stack Hint: To spend before the secret is revealed, Vanderpoole uses his signature. After the secret is revealed, you use your signature, a hash of the secret, and provide a 0 because the script has moved past the unrevealed verification.`,
  ...
  validation: {
    ...
    nope_try_again_2: `Nope! Try again..`,
    nope_try_again_3: `Nope! Try again...`,
    nope_try_again_4: `Nope! Try again....`,
    not_valid_hex: `Not a valid hex value`,
    please_return_value: `Please return a value`,
    return_value: `Return a value`,
    no_output: `No output`,
    incorrect: `Incorrect`,
    invalid_block: `Invalid block, keep working!`,
    hash_not_valid: `Hash is not valid`,
    hash_length_invalid: `Hash must be 64 characters long.`,
    hash_prefix_invalid: `Hash must start with 5 zeroes.`,
    ensure_proper_decoding: `Ensure you are properly decoding your answer`,
    array_20_bytes: `Array must be 20 bytes long`,
    not_hex_value: `Answer is not a hexadecimal value`,
    ensure_own_key: `Ensure you are using your own key object`,
    ensure_multiply_by_g: `Ensure you are multiplying the private key by G`,
    try_multiply_g: `Try multiplying with the G constant`,
    try_logging_answer: `Try logging out your answer`,
    not_quite_right: `That is not quite right, try again.`,
    check_your_methods: `Check your methods`,
    close_but_reduce_change: `Close! Don't forget to reduce our change from 61,000,000 to 60,999,000 in order to pay the miners.`,
    ensure_push_serialize: `Ensure you are correctly pushing and serializing the data`,
    length_not_valid: `Length isn't valid`,
  },
