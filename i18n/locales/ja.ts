...
chapter_six: {
  ...
  intro_two: {
    ...
    paragraph_six: `—ミカ3000：「度胸はあるようですが、それだけでは足りません。あなたが見つけたことは、物語の序章にすぎません。この先を知るには、ヴァンダープールの私有島に行く必要があります。資金もそれなりに必要です。以前、一緒にセットアップしたマルチシグウォレット、覚えていますか？あなたは、まだ私の鍵の1つを持っていますね。──資金を引き出すのを手伝ってほしいです、協力してくれますか？」`,
  },
in_out_one: {
  title: `入出力の基本`,
  nav_title: `未使用のUTXO`,
...
chapter_seven: {
  ...
  intro_one: {
    ...
    paragraph_four: `―ミカ3000：「スパイ活動にアロハシャツで来るなんて……いったい何を考えていらしたんですか？ここはただの廃倉庫じゃありませんよ、要塞なんですから。あ、そうそう。うっかりしてました。こちら、グラップリングフックもお持ちください。」`,
...
outro_two: {
  ...
  paragraph_two: `—ヴァンダープール：「俺たちは互いのことをよく知らないが、祖父がよく言っていたんだ。『見知らぬ者同士でも、運命は交差するものだ』ってな。聞いてほしい。サトシ・ナカモトの件は全部、家業を守るためだったんだ。マイニングが俺たちにとってどれだけ大切だったか、君には想像もつかないだろう。変化を受け入れる覚悟ができてなかったんだ。現状を保ちたかった、それだけなんだ。」`,
},
...
outro_four: {
  ...
  paragraph_two: `—ホロキャット：「あなたは悪人じゃないニャ、ヴァンダープールさん。でも、もしかしたら……ちょっと気にしすぎたのかもしれないニャン。」`,
