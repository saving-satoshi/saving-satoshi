...
export default async function Page({ params }) {
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 w-screen h-screen justify-center'>
            <div className='flex justify-start w-full text-white '>
                <div className='content-center justify-items-start sm:p-10 px-1 py-6 sm:py-10'>
                    <div
