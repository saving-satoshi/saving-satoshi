      ...
      readingResources={
        <>
          <Text className="mt-[25px] text-xl font-bold">
            {t(
              'chapter_five.resources.validate_signature_one.message_verification_heading'
            )}
          </Text>
          <Text>
            {t(
              'chapter_five.resources.validate_signature_one.message_verification_paragraph_one'
            )}
          </Text>
        </>
      }
