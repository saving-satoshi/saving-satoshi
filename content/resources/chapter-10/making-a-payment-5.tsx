...
export default function MakingAPaymentFive({ lang }) {
          ...
          {challengeIsToggled && (
            <div className="text-white ">
              ...
              <CodeExample
                ...
                text
                language="bash"
                code="OP_IF OP_PUSH 700 OP_CHECKSEQUENCEVERIFY OP_DROP OP_PUSH PUBKEY(LASZLO) OP_CHECKSIG OP_ELSE OP_2 OP_PUSH PUBKEY(REVOCATION_LASZLO_1) OP_PUSH PUBKEY(YOU) OP_2 OP_CHECKMULTISIG OP_ENDIF"
              />
              <Text className="mt-2">
