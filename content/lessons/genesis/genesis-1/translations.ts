  ...
  genesis_one: {
    en: {
      ...
      tooltip_block_explorer:
        'A <a href="https://blockstream.info/" target="_blank" rel="noreferrer">block explorer</a> is a tool that allows users to view the contents of a blockchain, including transactions, addresses, and other important data.',
      tooltip_hex:
    ...
    nl: {
      ...
      tooltip_block_explorer:
        'Een <a href="https://blockstream.info/" target="_blank" rel="noreferrer">block explorer</a> is een tool waarmee gebruikers de inhoud van een blockchain kunnen bekijken, inclusief transacties, adressen en andere belangrijke gegevens.',
      tooltip_hex:
